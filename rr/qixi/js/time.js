function showTime() {
	...
	var startDate = new Date(2019,06,14,23,50,20);
	...
	if (seconds < 10)
	seconds = "0" + seconds;
	var currentTimeString = "Dear 刘冉冉:<br>"
		+ "我们已相恋:<br> "
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----   2019-07-14 23:50:20</c>";
